...
### Grid Search for best parameters of RF
from Gridsearch_fun import RF_GridSearch
RF_GS = RF_GridSearch()
print(f'start RF grid search')
t1 = time.time()
RF_best = RF_GS.get_bestparam(Final_train, Y_train)
t2 = time.time()
print(f'Grid search for RF best parameters is done, processing time: {t2-t1}')
print(f'RF best parameters: {RF_best}')

### Grid Search for best parameters of NN
from Gridsearch_fun import MLP_GridSearch
MLP_GS = MLP_GridSearch()
print(f'start NN grid search')
t1 = time.time()
MLP_best = MLP_GS.get_bestparam(Final_train, Y_train)
t2 = time.time()
print(f'Grid search for MLP best parameters is done, processing time: {t2-t1}')
print(f'MLP best parameters: {MLP_best}')